  ...
  public static final class ModEvents {
    ...
    public static void gatherData(final GatherDataEvent event) {
      ...
      if (event.includeClient()) {
         ...
         * generator.addProvider( new ModDataGeneration.ItemModelGen(generator,
         * existingFileHelper)); generator.addProvider( new
         * ModDataGeneration.BlockStateGen(generator, existingFileHelper));
         */
      }
    }
