...
public class BeanPieces {
    static final ResourceLocation STRUCTURE_LOCATION = new ResourceLocation(CommunityMod.MODID + ":bean_structure");    public static final StructurePieceType BEAN_TYPE = BeanPiece::new;
    public BeanPieces() {
    }
