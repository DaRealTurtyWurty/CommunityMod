...
public class ConfiguredStructures {
    ...
    public static final ConfiguredStructureFeature<?, ?> CONFIGURE_TEST_STRUCTURE = StructureInit.BEAN_STRUCTURE.get().configured(FeatureConfiguration.NONE);

    public static void registerConfiguredStructures() {
        Registry<ConfiguredStructureFeature<?, ?>> registry = BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE;

        Registry.register(registry, new ResourceLocation(CommunityMod.MODID, "configured_bean"), CONFIGURE_TEST_STRUCTURE);
         ...
         */
        FlatLevelGeneratorSettings.STRUCTURE_FEATURES.put(StructureInit.BEAN_STRUCTURE.get(), CONFIGURE_TEST_STRUCTURE);
    }
}
