...
public final class ItemInit {
    ...
    private static final FoodProperties BEAN_SOUP_PROPERTIES = new FoodProperties.Builder().nutrition(8).saturationMod(0.6F)
    ...
    public static final RegistryObject<Item> MIGUEL_OF_FORTUNE = ITEMS.register("miguel_of_fortune",
            () -> new MiguelItem(new Item.Properties()
                    .tab(CommunityMod.TAB)));
    ...
    public static final RegistryObject<Item> ORB_OF_INSANITY = ITEMS.register("orb_of_insanity",
            () -> new OrbOfInsanity(new Item.Properties()
                    .tab(CommunityMod.TAB)
                    .stacksTo(1)
    ...
    public static final RegistryObject<Item> MUSIC_DISC_BEANAL = ITEMS.register("music_disc_beanal",
            () -> new RecordItem(5, SoundsInit.MUSIC_DISC_BEANAL::get,
                    new Item.Properties()
                            .tab(CommunityMod.TAB)
                            .stacksTo(1)
                            .rarity(Rarity.RARE)));
