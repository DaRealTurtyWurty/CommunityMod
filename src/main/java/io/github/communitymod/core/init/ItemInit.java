...
import io.github.communitymod.common.items.PowerBean;
...
public final class ItemInit {
	...
	public static final RegistryObject<Item> APPLE_INGOT = ITEMS.register("apple_ingot",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)
					.food(new FoodProperties.Builder().nutrition(1).saturationMod(10f).build())));
	...
	public static final RegistryObject<Item> CHEESE_ITEM = ITEMS.register("cheese_item",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)
					.food(new FoodProperties.Builder().nutrition(10).saturationMod(1.0f)
							...
							.effect(() -> new MobEffectInstance(MobEffects.HEALTH_BOOST, 7200, 10), 0.25f).build())));
	...
	public static final RegistryObject<Item> CHEESEBURGER = ITEMS.register("cheeseburger",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)
					.food(new FoodProperties.Builder().nutrition(100).saturationMod(100.0f)
							...
							.effect(() -> new MobEffectInstance(MobEffects.POISON, 40, 2), 1.0f).build())));
	public static final RegistryObject<Item> BURGER_TOPBUN = ITEMS.register("burger_topbun",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	public static final RegistryObject<Item> BURGER_BOTTOMBUN = ITEMS.register("burger_bottombun",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	public static final RegistryObject<Item> BURGER_CHEESE = ITEMS.register("burger_cheese",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	public static final RegistryObject<Item> BURGER_LETTUCE = ITEMS.register("burger_lettuce",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	public static final RegistryObject<Item> BURGER_TOMATO = ITEMS.register("burger_tomato",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	public static final RegistryObject<Item> BURGER_MEAT = ITEMS.register("burger_meat",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	public static final RegistryObject<Item> BURGER_INGREDIENTS = ITEMS.register("burger_ingredients",
			() -> new Item(new Item.Properties().tab(CommunityMod.TAB)));
	// End burger stuff
	...
	public static final RegistryObject<Item> WOODEN_SPOON = ITEMS.register("wooden_spoon",
			() -> new SpoonTemplate(Tiers.WOOD, 5.0f, -2.0f,
	...
	public static final RegistryObject<Item> STONE_SPOON = ITEMS.register("stone_spoon",
			() -> new SpoonTemplate(Tiers.STONE, 5.0f, -2.0f,
	...
	public static final RegistryObject<Item> GOLDEN_SPOON = ITEMS.register("golden_spoon",
			() -> new SpoonTemplate(Tiers.GOLD, 5.0f, -2.0f,
	...
	public static final RegistryObject<Item> IRON_SPOON = ITEMS.register("iron_spoon",
			() -> new SpoonTemplate(Tiers.IRON, 5.0f, -2.0f,
	...
	public static final RegistryObject<Item> DIAMOND_SPOON = ITEMS.register("diamond_spoon",
			() -> new SpoonTemplate(Tiers.DIAMOND, 5.0f, -2.0f,
	...
	public static final RegistryObject<Item> NETHERITE_SPOON = ITEMS.register("netherite_spoon",
			() -> new SpoonTemplate(Tiers.NETHERITE, 5.0f, -2.0f,
	...
	public static final RegistryObject<Item> BEAN_OF_POWER = ITEMS.register("bean_of_power",
			() -> new PowerBean(new Item.Properties().tab(CommunityMod.TAB).stacksTo(1).rarity(Rarity.RARE)));
