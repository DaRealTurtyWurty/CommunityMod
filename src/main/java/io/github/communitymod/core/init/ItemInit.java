...
public final class ItemInit {
  ...
  public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, CommunityMod.MODID);
  ...
  public static void registerBlockItems(final RegistryEvent.Register<Item> event) {
    ...
    BlockInit.BLOCKS.getEntries().stream().filter(object -> !BLOCK_ITEM_BLACKLIST.contains(object)).forEach(block -> {
