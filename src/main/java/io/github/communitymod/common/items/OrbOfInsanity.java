...
public class OrbOfInsanity extends Item {
    public OrbOfInsanity(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        String message = "If you receive this message, then AAAAAAAAAAAAAAAA";
        int res = rand.nextInt(32);
        player.sendMessage(new TextComponent("The orb glows and leaves you with the number " + res),
                player.getUUID());
        switch (res) {
            case 0:
                player.kill();
            ...
            case 31:
                ...
                int numsAdded = 0; // Max 100.
                while (numsAdded < 100 && rand.nextInt(100) != 19) {
                    builder.append("This is not the orb's message: ").append(rand.nextInt(999999999)).append("! ");
                    numsAdded++;
                }
